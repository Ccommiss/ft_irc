...
nnoremap  a; ld$a;
nnoremap  d; d$a;
nnoremap  ct i std::cout <<  << std::endl;|f<lla
...
let Taboo_tabs = "1	SERVER\n2	USER\n3	INIT\n4	RUN\n"
silent only
silent tabonly
cd /sgoinfre/goinfre/Perso/csejault/ft_irc
...
argglobal
%argdel
$argadd includes/Server.hpp
$argadd srcs/Server_tcp/Server_tcp.cpp
$argadd srcs/Server_tcp/Server_tcp_end_connection.cpp
$argadd srcs/Server_tcp/Server_tcp_existing_connection.cpp
$argadd srcs/Server_tcp/Server_tcp_get_addr.cpp
$argadd srcs/Server_tcp/Server_tcp_new_connection.cpp
$argadd srcs/Server_tcp/Server_tcp_run.cpp
$argadd srcs/Server_tcp/Server_tcp_set_monitoring.cpp
$argadd srcs/Server_tcp/Server_tcp_shutdown.cpp
$argadd srcs/Server_tcp/Server_tcp_start_listening.cpp
$argadd srcs/Server_tcp/Server_tcp_utils.cpp
set stal=2
tabnew
tabnew
tabnew
...
wincmd w
argglobal
if bufexists("srcs/Server_tcp/Server_tcp.cpp") | buffer srcs/Server_tcp/Server_tcp.cpp | else | edit srcs/Server_tcp/Server_tcp.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("srcs/User.cpp") | buffer srcs/User.cpp | else | edit srcs/User.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
5argu
if bufexists("srcs/Server_tcp/Server_tcp_set_monitoring.cpp") | buffer srcs/Server_tcp/Server_tcp_set_monitoring.cpp | else | edit srcs/Server_tcp/Server_tcp_set_monitoring.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
5argu
if bufexists("srcs/Server_tcp/Server_tcp_start_listening.cpp") | buffer srcs/Server_tcp/Server_tcp_start_listening.cpp | else | edit srcs/Server_tcp/Server_tcp_start_listening.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
3argu
if bufexists("srcs/Server_tcp/Server_tcp_shutdown.cpp") | buffer srcs/Server_tcp/Server_tcp_shutdown.cpp | else | edit srcs/Server_tcp/Server_tcp_shutdown.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
3argu
if bufexists("srcs/Server_tcp/Server_tcp_new_connection.cpp") | buffer srcs/Server_tcp/Server_tcp_new_connection.cpp | else | edit srcs/Server_tcp/Server_tcp_new_connection.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
3argu
if bufexists("srcs/Server_tcp/Server_tcp_existing_connection.cpp") | buffer srcs/Server_tcp/Server_tcp_existing_connection.cpp | else | edit srcs/Server_tcp/Server_tcp_existing_connection.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
argglobal
1argu
if bufexists("srcs/Server_tcp/Server_tcp_utils.cpp") | buffer srcs/Server_tcp/Server_tcp_utils.cpp | else | edit srcs/Server_tcp/Server_tcp_utils.cpp | endif
setlocal keymap=
setlocal noarabic
setlocal noautoindent
setlocal backupcopy=
...
tabnext 3
set stal=1
badd +1 includes/Server.hpp
badd +1 srcs/Server_tcp/Server_tcp.cpp
badd +1 srcs/Server_tcp/Server_tcp_end_connection.cpp
badd +1 srcs/Server_tcp/Server_tcp_existing_connection.cpp
badd +1 srcs/Server_tcp/Server_tcp_get_addr.cpp
badd +1 srcs/Server_tcp/Server_tcp_new_connection.cpp
badd +8 srcs/Server_tcp/Server_tcp_run.cpp
